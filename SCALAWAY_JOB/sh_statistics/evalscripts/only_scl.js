//VERSION=3
/**
 * Sentinel Hub Evalscript for Soil Feature Computation (SCL-Only Filtering)
 *
 ...
 * - 2 band ratios
 *
 * Includes ONLY SCL-based filtering for:
 * - Clouds, shadows, water, snow/ice (via SCL)
 * - NO sun zenith angle filtering
 * - NO vegetation filtering
 * - NO water filtering
 *
 * This relaxed filtering should significantly increase data availability
 * while still excluding obviously problematic pixels.
 */
...
function evaluatePixel(s) {
  // --- Base pixel-level validity --- ONLY SCL filtering ---
