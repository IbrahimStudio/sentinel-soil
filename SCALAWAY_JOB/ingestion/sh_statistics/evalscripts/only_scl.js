//VERSION=3
/**
 * Sentinel Hub Evalscript for Soil Feature Computation (SCL-only)
 * - Valid when dataMask==1 AND SCL passes
 * - No NDVI threshold
 *
 * Output matches pipeline: features(18), valid(1), dataMask(1)
 */
...
function isBadSCL(scl) {
  // Same policy as your reference script:
  // Exclude: cloud shadow, water, high clouds, cirrus, snow/ice
  // Allows SCL 7 and 8 (permissive)
